...
// ... (existing helper functions and components remain the same)
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        {/* Gráfico Circular: Distribución por Activos (Existente) */}
        ...
        {/* Gráfico de Barras: Ganancia/Pérdida por Activo (%) (Existente) */}
        <Card>
