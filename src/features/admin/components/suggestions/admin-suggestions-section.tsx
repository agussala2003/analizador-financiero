...
import { CheckCircle, XCircle, Clock, ThumbsUp, Trash2, Calendar } from 'lucide-react';
      ...
      <Card>
        <CardContent className="p-12">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-3 text-muted-foreground">Cargando sugerencias...</span>
          </div>
        </CardContent>
      </Card>
    );
      ...
      {suggestions.length === 0 ? (
        <Card>
          <CardContent className="p-12 text-center">
            <p className="text-muted-foreground">No hay sugerencias con este filtro</p>
          </CardContent>
        </Card>
      ) : (
