...
import { XIcon, PlusIcon, SearchIcon, BarChart2, Briefcase, GitCompareArrows, LayoutGrid, Zap, BrainCircuit, AreaChart } from "lucide-react";
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <h1 className="text-3xl font-bold tracking-tight mb-2">Dashboard de Análisis</h1>
                <p className="text-muted-foreground mb-6">Añade, compara y analiza los activos que te interesan.</p>
            </motion.div>
